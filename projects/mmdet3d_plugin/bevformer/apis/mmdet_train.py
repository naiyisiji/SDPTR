...
# used in SDPTR projects
from projects.mmdet3d_plugin.datasets.builder_sdmap_nus import build_dataloader_fusion
def sdmap_fusion_detector(model,
                   dataset,
                   cfg,
                   distributed=False,
                   validate=False,
