...
class SDPTRHead(DETRHead):
    ...
    def forward(self, mlvl_feats, lidar_feat, 
                sd_map_feats, anchor_ele_expand, anchor_pts_expand, graph_label,
        ...
        if only_bev:  # only use encoder to obtain BEV features, TODO: refine the workaround
            ...
            outputs = self.transformer(
                ...
                img_metas=img_metas,
                prev_bev=prev_bev,
                sdmap_feats = sd_map_feats,
                anchor_ele_expand=anchor_ele_expand, 
                anchor_pts_expand=anchor_pts_expand,
                graph_label = graph_label
        )

        bev_embed, hs, init_reference, inter_references, class_ele = outputs
